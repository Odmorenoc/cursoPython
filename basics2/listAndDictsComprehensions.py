def run():
    #se crea una lista con los aportes del usuario
    ...
    # ## Se crea las ListComprehensions 
    ...
    # crear un diccionario cuyas llaves sean los primeros 1000 numeros naturales con sus raices cuadradas como valores

    # # dict={}
    # # for i in range(1,1001):
    # #     dict[i]=round(i**0.5,2)
    
    # ## Se crea el dictComprehesion
